...
import { findAllUsers, getSingleUserData, createUser, updateUserById, deleteUserById, addFriendToUser, deleteFriendFromUser, getAllThoughts, getSingleThoughtById, createThought, updateThoughtById, deleteThoughtById, createReaction, deleteReactionById } from '../controllers/api_controllers.js';
const router = Router();
// GET all users
